...
#     def __init__(self, args, root, list_path, max_iters=None, crop_size=(321, 321), mean=(128, 128, 128), scale=True, mirror=True, ignore_label=255, set='val'):
#         self.root = root
...
class cityscapesDataSet(data.Dataset):
    def __init__(self, args, root, list_path, max_iters=None, set='train'):
        self.root = root
        self.list_path = list_path
