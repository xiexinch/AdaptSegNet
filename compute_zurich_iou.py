...
if __name__ == "__main__":
    ...
    parser.add_argument('--gt_dir', default='data/dark_zurich/val/', type=str, help='directory which stores CityScapes val gt images')
    parser.add_argument('--pred_dir', default='./work_dirs/results', type=str, help='directory which stores CityScapes val pred images')
